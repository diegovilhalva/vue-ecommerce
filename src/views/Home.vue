              ...
              <v-carousel-item v-for="(item,i) in items" :key="i" :src="item.src" cover>
                <v-row>
                  <v-col cols="12" sm="6">
                    ...
                    <div class="d-flex fill-height justify-center align-center">
                      <p class="text text-white">{{ item.text }}</p>
                    </div>
                    <div class="d-flex fill-height justify-center align-center">
                      <v-btn style="margin-top: -120px;">Comprar</v-btn>
                    </div>
                  </v-col>
                </v-row>
              </v-carousel-item>
                ...
                <v-card class="mx-auto my-12 pb-4" max-width="374" color="red">
                  <v-row>
                    <v-col cols="12" sm="6">
                      <v-card-item class="mt-10">
                        <v-card-title class="text-center"
                          >Asus Rog GT51CH‑AE004T Pc </v-card-title
                        >
                      </v-card-item>
                ...
                <v-card class="mx-auto my-12 pb-4" max-width="374">
                  <v-row>
                    <v-col cols="12" sm="6">
                      <v-card-item class="mt-10">
                        <v-card-title class="text-center"
                          >CM 10 S2 Kule Hoparlör</v-card-title
                        >
                      </v-card-item>
